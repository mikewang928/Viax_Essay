# -*- coding: utf-8 -*-
"""
Created on Sat Sep 11 20:08:00 2021
...
class Node:
    ...
    def check_split(self):
        if not self.is_leaf_node():
            self.split_func = LogisticRegression(max_iter = 300)
        ...
        while inter < iterations:
            ...
            while len(nodes) > 0:
                ...
                if n_temp.left is not None:
                    ...
                    internal_label_train = left_error.astype(np.int16) - right_error.astype(np.int16) # 1 left, 0 don't care, -1 right
