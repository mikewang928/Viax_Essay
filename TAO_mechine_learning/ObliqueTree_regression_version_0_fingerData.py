# -*- coding: utf-8 -*-
"""
Created on Sat Sep 11 22:36:19 2021
...
X_train = Data_Feature_sub_10_train
X_test = Data_Feature_sub_10_test
...
class Node:
    ...
    def __init__(self, left=None, right=None, parent = None, *,split_func=None, indicator=None): 
        ...
        self.split_func = svm.SVR(kernel='linear',C=1e-1)
        # self.split_func = svm.SVC(kernel='linear')
        self.predictor = 0 # when splitfunction can not be used

    def check_split(self):
        if not self.is_leaf_node():
            self.split_func = LogisticRegression(C=3e-2, max_iter = 100)
